...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        DC01 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/8413f90a054b6c415703bae02badeba7541344f6/Archive/decoders/DC01\%206\%20Bit\%20Binary\%20Decoder/DC01\_6bit\_decoder.litematic?raw=1}{DC01\_6bit\_decoder.litematic} & Litematic of decoder. \\
        \thickhline
    \end{tabularx}
\end{table}
\end{document}
