...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        DC01 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/b56572c0d2b4f182d9e9d41449d8cb2963b923ae/Archive/decoders/DC01\%206\%20Bit\%20Binary\%20Decoder/DC01\_6bit\_decoder.litematic?raw=1}{DC01\_6bit\_decoder.litematic} & Litematic of decoder. \\
        \thickhline
    \end{tabularx}
\end{table}
\end{document}
