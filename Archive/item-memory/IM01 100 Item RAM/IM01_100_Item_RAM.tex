...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        IM01 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/92d3541e07ddc3ab90360e923907f040eca76834/Archive/item-memory/IM01\%20100\%20Item\%20RAM/IM01\_100\_item\_memory\_1.17.1.litematic?raw=1}{IM01\_100\_item\_memory\_1.17.1.litematic} & Litematic of item RAM device. \\
        \thickhline
    \end{tabularx}
\end{table}
