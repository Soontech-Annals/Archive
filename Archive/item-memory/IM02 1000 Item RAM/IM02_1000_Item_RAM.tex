...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        IM02 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/364bde8dbcbc2e5337489ff435bcda9b387017e2/Archive/item-memory/IM02\%201000\%20Item\%20RAM/IM02\_1000\_item\_RAM\_p2.litematic?raw=1}{IM02\_1000\_item\_RAM\_p2.litematic} & Litematic of item RAM device. \\
        \thickhline
    \end{tabularx}
\end{table}
