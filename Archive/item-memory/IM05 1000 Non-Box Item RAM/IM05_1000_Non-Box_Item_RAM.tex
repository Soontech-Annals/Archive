...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        IM05 & 1.19.3 & \href{https://github.com/Soontech-Annals/Archive/blob/b56572c0d2b4f182d9e9d41449d8cb2963b923ae/Archive/item-memory/IM05\%201000\%20Non-Box\%20Item\%20RAM/IM05\_1000\_Non-Box\_Item\_RAM.litematic?raw=1}{IM05\_1000\_Non-Box\_Item\_RAM.litematic} & Schematic of device. Includes dummy item storage. \\
        \hline
        \thickhline
    \end{tabularx}
\end{table}
