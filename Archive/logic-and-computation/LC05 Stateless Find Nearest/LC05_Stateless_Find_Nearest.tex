...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        LC05 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/b56572c0d2b4f182d9e9d41449d8cb2963b923ae/Archive/logic-and-computation/LC05\%20Stateless\%20Find\%20Nearest/LC05\_stateless\_find\_nearest.litematic?raw=1}{LC05\_stateless\_find\_nearest.litematic} & Schematic of device. \\
        \hline
        \thickhline
    \end{tabularx}
\end{table}
