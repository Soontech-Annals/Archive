...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        LC05 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/5523ae5cc654e4a5ac0b187df2fc60842c8476f2/Archive/logic-and-computation/LC05\%20Stateless\%20Find\%20Nearest/LC05\_stateless\_find\_nearest.litematic?raw=1}{LC05\_stateless\_find\_nearest.litematic} & Schematic of device. \\
        \hline
        \thickhline
    \end{tabularx}
\end{table}
