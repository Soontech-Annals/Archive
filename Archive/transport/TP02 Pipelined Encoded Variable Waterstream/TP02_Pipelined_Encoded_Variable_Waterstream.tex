...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l | l | l | X}
        ...
        \hline
        TP02 & 1.17.1 & \href{https://github.com/Soontech-Annals/Archive/blob/8413f90a054b6c415703bae02badeba7541344f6/Archive/transport/TP02\%20Pipelined\%20Encoded\%20Variable\%20Waterstream/TP02\_Pipelined\_Encoded\_Variable\_Waterstream.litematic?raw=1}{TP02\_Pipelined\_Encoded\_Variable\_Waterstream.litematic} & Schematic of device. \\
        \hline
        \thickhline
    \end{tabularx}
\end{table}
